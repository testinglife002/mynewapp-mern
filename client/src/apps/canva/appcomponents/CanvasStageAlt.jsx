...
// GenericShape Component for rect, circle, text
...
// Main CanvasStage Component
export default function CanvasStageAlt({ stageRef }) {
  const { width, height, background, elements, selectedIds, select, updateElement, removeSelected } =
    useEditorStore();
